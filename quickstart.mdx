...
<Steps>
  ...
  <Step title="Connect payments">
    Configure your Cashu mint or Lightning node using environment variables. Create a `.env` file with your payment settings:
    ...
    MINIMUM_PAYOUT=100
    ```
    Then run the proxy with your `.env` file:
